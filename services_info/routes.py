    ...
    def __init__(self, app):
        ...
        def add_informe_fc03():
            ...
            try:
                ...
                items = [{'cuenta':'26112','subcuenta':'1','analitico1':'9','analitico2':'99','descripcion':"Muebles y enseres \nmobiliarios y enseres de oficina \nEscritorios \notros tipos de escritorio\nMESA DE MADERA CLASSIC MOBLES {10643}",'fecha_adquisicion':'20-12-2018','rotulado':'18-6-3-1224','cantidad':'1','valor_unitario':'363.636','valor_total':'363.636','bienes':'','estado_conservacion':'B.','diferencia_libro':'','observacion':''},
                        {'cuenta':'26112','subcuenta':'1','analitico1':'9','analitico2':'99','descripcion':"Muebles y enseres \nmobiliarios y enseres de oficina \nEscritorios \notros tipos de escritorio\nMESA DE MADERA CLASSIC MOBLES {10643}",'fecha_adquisicion':'20-12-2018','rotulado':'18-6-3-1224','cantidad':'1','valor_unitario':'363.636','valor_total':'363.636','bienes':'','estado_conservacion':'B.','diferencia_libro':'','observacion':''},
                        {'cuenta':'26112','subcuenta':'1','analitico1':'9','analitico2':'99','descripcion':"Muebles y enseres \nmobiliarios y enseres de oficina \nEscritorios \notros tipos de escritorio\nMESA DE MADERA CLASSIC MOBLES {10643}",'fecha_adquisicion':'20-12-2018','rotulado':'18-6-3-1224','cantidad':'1','valor_unitario':'363.636','valor_total':'363.636','bienes':'','estado_conservacion':'B.','diferencia_libro':'','observacion':''}
                        ]
                #json to string
        ...
        def add_informe_fc05():
            ...
            try:
                ...
                insert_informe_fc05([
                    ...
                    registro['valor_unitario'],registro['origen'],registro['saldo'],registro['total'],ultimo_numero,hoy,str(datetime.today().month),str(datetime.today().year)
                    ])
                return jsonify(
                    {
                        "status": "OK"
