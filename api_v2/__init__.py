...
# api_v2.add_url_rule('/contador/<name>', view_func=ContadorLastIdService.as_view('contador_last_api'))
# [fc03]----------------------------------------------------------------------------------------------------------------
...
api_v2.add_url_rule('/fc06/items/<int:year>', view_func=FC06ItemsService.as_view('fc06_year'))
# [fc10]----------------------------------------------------------------------------------------------------------------
